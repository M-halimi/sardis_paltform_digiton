    <footer class="max-w-7xl mx-auto py-4">
        ...
        <div class="flex flex-col md:flex-col lg:flex-row lg:justify-between items-center mt-4 space-y-4 md:space-y-0 px-6">
            ...
            <span
              ...
              YouTube
                ...
                <ul class="flex  justify-center items-center  order-1 space-x-6">
                    <li>
                        <a href="#" class="hover:text-cobalt-900  hover:animate-bounce transition-colors duration-300">
