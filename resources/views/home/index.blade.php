<x-guest-layout>
    ...
    <header>
        <div
            class="max-h-screen py-16 flex flex-col items-center justify-center bg-cover backdrop-blur-sm object-cover aspect-square bg-center w-full md:py-0"
        ...
        <div class="flex flex-col justify-center items-center px-4 md:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 px-2 md:px-4 py-4 md:py-8 mt-6">
                ...
                <div class="flex flex-col justify-center items-center space-y-4">
                    <p class="block font-normal  md:px-8 px-1.5 text-lg tracking-wider leading-relaxed ">
        ...
        <div class="flex flex-col justify-center items-center px-4 md:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 px-2 md:px-4 py-4 md:py-8 mt-6">
                ...
                <div class="flex flex-col justify-center items-center space-y-4">
                    ...
                    <p class="font-normal max-w-xl md:px-8 px-1.5 text-lg tracking-wider leading-relaxed text-justify lg:order-1">
                        La marque propose une large gamme de robinets, mitigeurs de cuisine et accessoires de salle de bain,
                        alliant performance écoénergétique,
                        design esthétique, confort et fiabilité. Basée à Barcelone,
                    </p>

                    <p class="font-normal max-w-xl md:px-8 px-1.5 text-lg tracking-wider leading-relaxed text-justify lg:order-1">
                        ramonsoler dispose de plus de 16 000 m² d’installations et respecte les normes les plus strictes en matière de certification.
                    ...
                    <p class="font-normal max-w-xl md:px-8 px-1.5 text-lg tracking-wider leading-relaxed text-justify lg:order-1">
                        ...
                        vous offrant un accès direct à ces produits haut de gamme pour vos besoins en robinetterie et accessoires de salle de bain.
                    </p>
    ...
    <section class="py-12 px-4 lg:px-14">
        <div x-data="BrandData()" class="w-full max-w-7xl mx-auto relative">
                        ...
                        <div class="shrink-0" :style="`width: ${100 / visibleItems}%`">
                            <div class="p-4">
                                <button @click="toggleBrand(brand.name)"
                                        class="block bg-white shadow-md px-8 mx-auto rounded-3xl overflow-hidden w-48 h-52 transition-all duration-300 hover:ring-4 hover:ring-blue-500"
                                ...
                                <div class="mt-2 text-center font-medium text-sm text-gray-700">
